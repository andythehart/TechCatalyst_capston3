...
To get a basic sense of data distribution, we can use two general queries.

For continuous variables, we can compute the average and standard deviation
```sql
SELECT AVG(continuous_col), STDDEV(continuous_col)
FROM fact_green_yellow;
```

For discrete variables, we can compute the frequencies for each category.
```sql
SELECT discrete_col, COUNT(*) AS frequency
FROM fact_green_yellow
GROUP BY discrete_col
ORDER BY discrete_col;
```

## Continuous Variables

| COL_NAME              | AVG          | STANDARD_DEVIATION |
|-----------------------|--------------|--------------------|
| trip_distance         | 4.561061582  | 320.779580296      |
| fare_amount           | 19.288329935 | 77.166477342       |
| extra                 | 1.443473051  | 2.570667415        |
| mta_tax               | 0.484853086  | 0.1282570439       |
| tip_amount            | 3.397782578  | 4.135729393        |
| tolls_amount          | 0.5663756198 | 2.22072533         |
| improvement_surcharge | 0.9748470777 | 0.2183084192       |
| total_amount          | 27.998728544 | 78.562281268       |
| congestion_surcharge  | 2.231187282  | 0.854774907        |
| airport_fee           | 0.1433030035 | 0.4910461818       |
| trip_duration         | 16.543790277 | 5121.56034909      |
| average_speed         | 16.265050132 | 1894.674166019     |

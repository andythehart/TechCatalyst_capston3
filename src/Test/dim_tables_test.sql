...
CREATE TABLE capstone_de.group_3_schema_test.dim_ratecode_test (
    id INT,
    ratecode VARCHAR
);
INSERT INTO capstone_de.group_3_schema_test.dim_ratecode_test (id, ratecode)
VALUES
(1, 'Standard Rate'),
(2, 'JFK'),
(3, 'Newark'),
...
CREATE TABLE capstone_de.group_3_schema_test.dim_payment_type_test (
    id INT,
    payment_type VARCHAR
);
INSERT INTO capstone_de.group_3_schema_test.dim_payment_type_test (id, payment_type)
VALUES
(1, 'Credit Card'),
(2, 'Cash'),
(3, 'No Charge'),
...
CREATE TABLE capstone_de.group_3_schema_test.dim_store_fwd_flag_test (
    y_n VARCHAR,
    s VARCHAR
);
INSERT INTO capstone_de.group_3_schema_test.dim_store_fwd_flag_test (y_n, s)
VALUES
('Y', 'store and forward trip'),
('N', 'not a store and forward trip');

CREATE TABLE capstone_de.group_3_schema_test.dim_trip_type_test (
    id INT,
    trip_type VARCHAR
);
INSERT INTO capstone_de.group_3_schema_test.dim_trip_type_test (id, trip_type)
VALUES
(1, 'Street-hail'),
(2, 'Dispatch');

CREATE TABLE capstone_de.group_3_schema_test.dim_vendor_id_test (
    id INT,
    vendor VARCHAR
);
INSERT INTO capstone_de.group_3_schema_test.dim_vendor_id_test (id, vendor)
VALUES
(1, 'Creative Mobile Technologies, LLC'),
(2, 'VeriFone Inc.');

CREATE TABLE capstone_de.group_3_schema_test.dim_zone_lookup_test (
    LocationId INT,
    Borough VARCHAR,
    Zone VARCHAR,
    service_zone VARCHAR
);
INSERT INTO capstone_de.group_3_schema_test.dim_zone_lookup_test(LocationID,Borough,Zone,service_zone)
VALUES
